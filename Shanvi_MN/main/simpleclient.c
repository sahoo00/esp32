...
#define GATTC_TAG "Shanvi MN Simple Client"
...
static void gattc_profile_event_handler(esp_gattc_cb_event_t event, esp_gatt_if_t gattc_if, esp_ble_gattc_cb_param_t *param)
{
    ...
    case ESP_GATTC_SEARCH_RES_EVT: {
        ...
        if (isUUIDpresent(srvc_id, &smph_service_uuid) || isUUIDpresent(srvc_id, &mn_service_uuid)) {
            ...
            if (count > 0){
                ...
                if (!char_elem_result){
                    ...
                    if (count > 0 && (char_elem_result[0].properties & ESP_GATT_CHAR_PROP_BIT_WRITE)){
                        gl_profile_tab[PROFILE_A_APP_ID].rx_handle = char_elem_result[0].char_handle;
                    ...
                    if (count > 0 && (char_elem_result[0].properties & ESP_GATT_CHAR_PROP_BIT_NOTIFY)){
                        gl_profile_tab[PROFILE_A_APP_ID].tx_handle = char_elem_result[0].char_handle;
            ...
            if (count > 0){
                ...
                if (!descr_elem_result){
                    ...
                    if (count > 0 && descr_elem_result[0].uuid.len == ESP_UUID_LEN_16 && descr_elem_result[0].uuid.uuid.uuid16 == ESP_GATT_UUID_CHAR_CLIENT_CONFIG){
                    	gl_profile_tab[PROFILE_A_APP_ID].cccd_handle = descr_elem_result[0].handle;
...
bool isSimpleClientReady() {
	return gl_profile_tab[PROFILE_A_APP_ID].ready_to_send;
}
